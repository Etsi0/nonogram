...
export function executeActionOnCells(actions) {
    if (!gridCells.length) {
        return;
    }
...
export function styledText(text, x, y, verticalAlign) {
